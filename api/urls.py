...
from .views import UserRegistration, UserLogin, ProfileView, ReadingListView, BookView, BookReviewView, UserReviewsView
...
urlpatterns = [
    ...
    path('user_reviews/<str:username>/', UserReviewsView.as_view(), name='user_reviews'),
    path('user_reviews/<str:username>/<int:review_id>/', UserReviewsView.as_view(), name='user_review_detail'),
]
if settings.DEBUG:
