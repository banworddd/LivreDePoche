...
SECRET_KEY = 'django-insecure-bealpnp8@9q=klif2h0%yu6mpm)uf0qy28sup=2mth0+nf19wx'
...
ROOT_URLCONF = 'LivreDePoche.urls'
...
WSGI_APPLICATION = 'LivreDePoche.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Убедитесь, что здесь указан правильный путь к вашей папке со статическими файлами
]
